...
namespace JokesApp.Web.Areas.Identity.Pages.Account.Manage
{
    public class EnableAuthenticatorModel : PageModel
    {
        ...
        private async Task LoadSharedKeyAndQrCodeUriAsync(JokesAppUser user)
        {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                AuthenticatorUriFormat, this._urlEncoder.Encode("JokesApp.Web"), this._urlEncoder.Encode(email),
                unformattedKey);
        }
    }
}
