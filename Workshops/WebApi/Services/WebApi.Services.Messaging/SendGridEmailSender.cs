namespace WebApi.Services.Messaging
{
    ...
    using WebApi.Services.Messaging.SendGrid;

    // Documentation: https://sendgrid.com/docs/API_Reference/Web_API_v3/Mail/index.html
    public class SendGridEmailSender : IEmailSender
    {
        private const string AUTHENTICATION_SCHEME = "Bearer";
        private const string BASE_URL = "https://api.sendgrid.com/v3/";
        private const string SEND_EMAIL_URL_PATH = "mail/send";
        ...
        public SendGridEmailSender(ILoggerFactory loggerFactory, string apiKey, string fromAddress, string fromName)
        {
            ...
            this.httpClient.DefaultRequestHeaders.Authorization =
                new AuthenticationHeaderValue(AUTHENTICATION_SCHEME, apiKey);
            this.httpClient.BaseAddress = new Uri(BASE_URL);
