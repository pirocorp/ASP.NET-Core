namespace IdentityDemo.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private const string RECOVERY_CODES_KEY = nameof(RECOVERY_CODES_KEY);
        ...
        public async Task<IActionResult> EnableAuthenticator(EnableAuthenticatorViewModel model)
        {
            ...
            this.TempData[RECOVERY_CODES_KEY] = recoveryCodes.ToArray();
        ...
        {
            var recoveryCodes = (string[]) this.TempData[RECOVERY_CODES_KEY];
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                this.urlEncoder.Encode("IdentityDemo"),
