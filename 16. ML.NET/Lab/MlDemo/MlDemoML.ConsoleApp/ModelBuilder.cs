...
namespace MlDemoML.ConsoleApp
{
    ...
    {
        private const string TRAIN_DATA_FILEPATH = @"F:\repos\ASP.NET-Core\16. ML.NET\Lab\MlDemo\01. MlDemo\yelp_labelled.txt";
        private const string MODEL_FILEPATH = @"C:\Users\Piroman\AppData\Local\Temp\MLVSTools\MlDemoML\MlDemoML.Model\MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(new SdcaMaximumEntropyMulticlassTrainer.Options() { L2Regularization = 0.001f, L1Regularization = 0f, ConvergenceTolerance = 0.001f, Shuffle = true, BiasLearningRate = 0f, LabelColumnName = "col1", FeatureColumnName = "Features" })
